...
| suíte | 172 arquivos / 3.121 testes (vitest) + 774 testes e 970 subtests (pytest, lab). Verde em rodada limpa e SOZINHA; com uma segunda corrida de vitest concorrente, dois a quatro arquivos de caminho selado batem no timeout de 20 s — dívida de § 7, não de política |
...
**Minha, e vence antes da primeira corrida certificadora:** o teto da fração descartada de
replicados (§ 7). A geometria da operação e o eco do pai estão **fechados** — as duas guardas correm
como descarte no laço, com o denominador publicado.
