...
| `evaluatorDigest` da árvore | `8f4923440043f0f9643fd1a9586bf30f2501e297472e22e30959b96950102b0d` — 52 arquivos, recomputado pela função de produção e **lido por teste nomeado** (`digests.test.ts`, "is published in the ESTADO at the value the LIVE tree hashes to"), então este número não pode envelhecer em silêncio. Mover é barato enquanto `issuedAt` é nulo |
