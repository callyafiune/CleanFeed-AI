...
| `evaluatorDigest` da árvore | `d108609845e5a42d7b144d990f1237ea7f3eb1847f715cc29833869a6b3ef554` — 53 arquivos, recomputado pela função de produção e **lido por teste nomeado** (`digests.test.ts`, "is published in the ESTADO at the value the LIVE tree hashes to"), então este número não pode envelhecer em silêncio. Mover é barato enquanto `issuedAt` é nulo |
...
outra vez — é isso que faz de ativar o perfil ato auditável e não configuração. O registro é injetável
