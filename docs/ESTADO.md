...
| suíte | 172 arquivos / 3.097 testes (vitest) + 714 testes e 520 subtests (pytest, lab). Verde em rodada limpa e SOZINHA; com uma segunda corrida de vitest concorrente, dois a quatro arquivos de caminho selado batem no timeout de 20 s — dívida de § 7, não de política |
| dos quais, o avaliador | 2.434 — 1.720 em 46 arquivos de `benchmark/tests`, 714 no lab |
| typecheck | limpo |
