...
| suíte | 172 arquivos / 3.115 testes (vitest) + 755 testes e 750 subtests (pytest, lab). Verde em rodada limpa e SOZINHA; com uma segunda corrida de vitest concorrente, dois a quatro arquivos de caminho selado batem no timeout de 20 s — dívida de § 7, não de política |
| dos quais, o avaliador | 2.493 — 1.738 em 46 arquivos de `benchmark/tests`, 755 no lab |
| typecheck | limpo |
