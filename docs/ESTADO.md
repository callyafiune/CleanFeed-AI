...
| `evaluatorDigest` da árvore | `8b3efb2b0fdecc17cc32041d33f2f37e9368372e63bf441cd35c615cd3e8bc8e` — 52 arquivos, recomputado pela função de produção e **lido por teste nomeado** (`digests.test.ts`, "is published in the ESTADO at the value the LIVE tree hashes to"), então este número não pode envelhecer em silêncio. Mover é barato enquanto `issuedAt` é nulo |
