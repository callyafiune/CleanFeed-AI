...
| suíte | 172 arquivos / 2.929 testes (vitest) + 577 testes e 117 subtests (pytest, lab). Verde em rodada limpa e SOZINHA; com uma segunda corrida de vitest concorrente, dois a quatro arquivos de caminho selado batem no timeout de 20 s — dívida de § 7, não de política |
...
| dívida | vence |
|---|---|
| a **fila do cross-review de dez unidades**: R1 pagou o `consolidado-c`, R2 o `consolidado-w1`, e a **onda A1** (2026-08-11) pagou **quatro** dos nove que mordiam agora — `validate` recusando antes de selar, o eixo do ledger por totalidade, o manifesto com guarda de localizador e o piso barato pareado por fatia. **Sobram 5 dos 9 que mordem agora** (as linhas abaixo), **14 que mordem antes de publicar** e **31 menores** ainda não refutados um a um. A auditoria e o que foi refutado estão no registro (§ "A auditoria de 2026-08-10"); a onda A1, com as duas rodadas de revisão que ela precisou, em § "A onda A1" | as cinco abaixo, agora; as catorze, antes da Fase 6 |
